...
const keyboard = new grammy_1.InlineKeyboard().webApp("🔑 Открыть личный кабинет", "https://frendik.ru");
bot.command("start", (ctx) => ctx.reply(WELCOME_TEXT, { reply_markup: keyboard }));
bot.start();
